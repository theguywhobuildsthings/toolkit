...
def test_token_encoding():
    ...
    print(unencoded)
    assert unencoded['test_fake_data'] == "test test", "Data should encode without changing"
...
def test_token_expiring():
    ...
    assert unencoded['exp'] == int(expected_time.timestamp()), "Token should have a valid expiry"
